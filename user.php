        ...
        <div class="col-4">
          <div class="list-group" id="list-tab" role="tablist">
            ...
            if ($admin == 1) {
              ...
              echo '<a class="list-group-item list-group-item-action zamowienia_bttn" id="list-zamowienia-list" data-bs-toggle="list" href="#list-zamowienia" role="tab" aria-controls="list-zamowienia">Zamówienia</a>';
            }
            ?>
